       ...
       <form action="" method="POST">
          <fieldset>
            ...
            <fieldset>
              ...
              <div class="form-group row">
                <div class="col-lg-6 col-md-6 col-12">
                  <label for="nameEnterprise">Nom de l'entreprise</label>
                  <input type="text" required name="nameEnterprise" value="<?= isset($_POST['nameEnterprise']) ? $_POST['nameEnterprise'] : '' ?>" class="form-control <?= isset($formErrors['nameEnterprise']) ? 'is-invalid' : (isset($nameEnterprise) ? 'is-valid' : '') ?>" id="nameEnterprise" placeholder="12 Boulevard Cambronne" />
                  <?php if (isset($formErrors['nameEnterprise'])) { ?>
                    <div class="invalid-feedback"><?= $formErrors['nameEnterprise'] ?></div>
                  <?php } ?>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                  <label for="country">N° SIREN</label>
