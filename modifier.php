                    ...
                    <div class="col-12 col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                          ...
                          <input type="text" required name="nameEnterprise" value="<?= isset($_POST['nameEnterprise']) ? $_POST['nameEnterprise'] : '' ?>" class="form-control <?= isset($formErrors['nameEnterprise']) ? 'is-invalid' : (isset($nameEnterprise) ? 'is-valid' : '') ?>" id="nameEnterprise" placeholder="Commerce" />
