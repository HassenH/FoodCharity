...
require_once 'controllers/usersUpdateCtrl.php';
?>
                            ...
                            <form action="" method="POST">
                                <div class="col-12 card border-0 bg-transparent">
                                    <div class="card-header text-center border-bottom-0 bg-light">
                                        <h2 class="ml-4 mb-0 card-title d-inline-block">Vos informations personnelles</h2>
                                    </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                                    ...
                                                    <input type="text" name="nameEnterprise" value="<?= isset($_POST['nameEnterprise']) ? $_POST['nameEnterprise'] : '' ?>" class="form-control <?= isset($formErrors['nameEnterprise']) ? 'is-invalid' : (isset($nameEnterprise) ? 'is-valid' : '') ?>" id="nameEnterprise" placeholder="Commerce" />
